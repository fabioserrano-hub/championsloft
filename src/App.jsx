...
const NAV = [
  ...
  { section: 'Sistema', items: [{ id: 'epoca', icon: '🗓️', label: 'Gestão Época' }, { id: 'precos', icon: '💳', label: 'Planos' }, { id: 'admin', icon: '👑', label: 'Admin' }, { id: 'perfil', icon: '⚙️', label: 'Perfil' }, { id: 'documentos', icon: '📄', label: 'Documentos' }] },
]
